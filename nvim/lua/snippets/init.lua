...
local function header()
  ...
  if ft == "cpp" or ft == "c" or ft == "verilog" then
    comment_str = "// "
  ...
  local ret = {
    comment_str .. "File:          " .. vim.fn.expand('%:t'),
    comment_str .. "Author:        ShenYuhang <768299856@qq.com>",
    comment_str .. "Date:          " .. os.date(),
    comment_str .. "Last Modified: " .. os.date(),
    ""
  }
  if ft == "python" or ft == "sh" then
    table.insert(ret, 1, shebang_line)
  end
  return ret
end

-- generate function comments when writing prototypes
local function function_comment(variables)
